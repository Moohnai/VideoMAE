...
def get_args():
    ...
    parser.add_argument('--output_dir', default='/home/mona/VideoMAE/results/pretrain_BB_scratch',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/home/mona/VideoMAE/results/pretrain_BB_scratch',
